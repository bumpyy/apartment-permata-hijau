    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="mx-4 w-full max-w-2xl rounded-lg bg-white p-6 shadow-xl">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <button wire:click="closeCrossCourtConflictModal" class="text-gray-400 hover:text-gray-600">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-orange-700">
                                <p>You cannot book multiple courts at the same time. You must be physically present to use the courts.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100">
                                        <span class="text-sm font-semibold text-blue-600">{{ substr($conflict['court_name'], -1) }}</span>
                                    </div>
                                    <div>
                                        <div class="font-medium text-gray-900">{{ $conflict['court_name'] }}</div>
                                        <div class="text-sm text-gray-600">{{ $conflict['start_time'] }} - {{ $conflict['end_time'] }}</div>
                                    </div>
                                </div>
            ...
            <div class="flex justify-end space-x-3">
                <button wire:click="closeCrossCourtConflictModal"
