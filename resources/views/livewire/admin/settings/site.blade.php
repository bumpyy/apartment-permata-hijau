<section class="w-full">
    ...
    <div class="space-y-8">
        ...
        <form class="space-y-8" wire:submit="updateSiteSettings">
            <!-- Site Information -->
                    ...
                    <div class="space-y-4">
                        ...
                        @if ($enable_realtime_polling)
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                                <flux:input wire:model="polling_interval_active" label="Active User Interval (seconds)"
                                    type="number" min="10" max="300" />
                                <flux:input wire:model="polling_interval_inactive"
                                    label="Inactive User Interval (seconds)" type="number" min="30"
                                    max="600" />
                                <flux:input wire:model="polling_interval_mobile"
                                    label="Mobile Device Interval (seconds)" type="number" min="15"
                                    max="300" />
                                <flux:input wire:model="inactivity_timeout" label="Inactivity Timeout (seconds)"
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-2 text-sm text-blue-700">
                                            ...
                                            <p><strong>Inactive Users:</strong> {{ $polling_interval_inactive }} seconds
                                            </p>
                                            <p><strong>Mobile Devices:</strong> {{ $polling_interval_mobile }} seconds
                                            </p>
                                            <p><strong>Inactivity Timeout:</strong> {{ $inactivity_timeout }} seconds
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-yellow-700">
                                            Real-time polling is disabled. Users will need to manually refresh to see
                                            booking updates.
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        @if ($enable_booking_system)
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <flux:input wire:model="max_bookings_per_tenant" label="Max Bookings per Tenant"
                                    type="number" min="1" max="10" />
                                <flux:input wire:model="booking_advance_days" label="Booking Advance Days"
                                    type="number" min="1" max="365" />
                                <flux:checkbox wire:model="allow_booking_cancellations"
                                    label="Allow Booking Cancellations" />
                                <flux:input wire:model="cancellation_hours_limit" label="Cancellation Hours Limit"
                                    type="number" min="1" max="168" />
                                <flux:checkbox wire:model="enable_cross_court_conflict_detection"
                                    label="Enable Cross-Court Conflict Detection" />
                            </div>
                            ...
                            @if ($enable_cross_court_conflict_detection)
                                <div class="rounded-lg border border-blue-200 bg-blue-50 p-4">
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <h4 class="text-sm font-medium text-blue-800">Cross-Court Conflict
                                                Detection</h4>
                                            <div class="mt-2 text-sm text-blue-700">
                                                <p>Prevents tenants from booking multiple courts at the same time.</p>
                                                <p>This helps ensure tenants can only use one court at a time since they
                                                    must be physically present.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="rounded-lg bg-white shadow">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <flux:input wire:model="cache_duration" label="Cache Duration (seconds)" type="number"
                            min="60" max="3600" />
            ...
            <div class="rounded-lg bg-white shadow">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <flux:input wire:model="rate_limit_requests" label="Rate Limit Requests" type="number"
                            min="10" max="1000" />
                        <flux:input wire:model="rate_limit_minutes" label="Rate Limit Minutes" type="number"
                            min="1" max="60" />
