                ...
                <form wire:submit.prevent="exportBookings" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" wire:model="exportDateFrom" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Date To</label>
                            <input type="date" wire:model="exportDateTo" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select wire:model="exportStatusFilter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                <option value="">All Statuses</option>
                                <option value="pending">Pending</option>
                                <option value="confirmed">Confirmed</option>
                                <option value="cancelled">Cancelled</option>
                        ...
                        <div>
                            ...
                            <select wire:model="exportCourtFilter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select wire:model="exportBookingTypeFilter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="text-sm text-gray-600 space-y-1">
                            <p>• Date Range: {{ $exportDateFrom ? \Carbon\Carbon::parse($exportDateFrom)->format('M j, Y') : 'Not set' }} - {{ $exportDateTo ? \Carbon\Carbon::parse($exportDateTo)->format('M j, Y') : 'Not set' }}</p>
                            <p>• Status: {{ $exportStatusFilter ? ucfirst($exportStatusFilter) : 'All' }}</p>
                            <p>• Court: {{ $exportCourtFilter ? ($this->courts->firstWhere('id', $exportCourtFilter)->name ?? 'All') : 'All' }}</p>
                            <p>• Type: {{ $exportBookingTypeFilter ? ucfirst($exportBookingTypeFilter) : 'All' }}</p>
                            <p>• Format: {{ strtoupper($exportFormat) }}</p>
                        </div>
                    </div>
