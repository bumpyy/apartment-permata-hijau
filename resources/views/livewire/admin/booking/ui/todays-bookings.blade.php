@if ($this->todaysBookings->isNotEmpty())
    <div class="mb-6" x-data="{ showTodaysBookings: true }">
        <div class="mb-4 flex items-center justify-between">
            ...
            <button class="text-sm text-blue-600 hover:text-blue-800"
                x-on:click="showTodaysBookings = !showTodaysBookings" x-text="showTodaysBookings ? 'Hide' : 'Show'">

            </button>
        </div>

        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3" x-show="showTodaysBookings">
